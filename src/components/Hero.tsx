          ...
          <ul className="mt-2.5 flex items-stretch justify-center gap-1.5 md:mt-3 md:gap-3">
            {sdgGoals.map((goal) => (
              ...
              >
                ...
                <span className="mt-auto pt-2 text-center [font-family:var(--font-geist-mono)] text-[9px] font-medium uppercase tracking-[0.1em] text-white/55 md:pt-2.5 md:text-[10px]">
                  SDG {goal.number}
                </span>
              </li>
            ))}
